...
<img style="display: block; margin-left: auto; margin-right:auto;" src="static/images/idf-equation.png">

Once idf<sub>i</sub> is calculated, tf-idf<sub>i</sub> is tf<sub>i</sub> multiplied by idf<sub>i</sub>. 

<img style="display: block; margin-left: auto; margin-right:auto;" src="static/images/tf-idf-equation.png">
